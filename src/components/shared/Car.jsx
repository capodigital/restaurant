...
const Car = (props) => {
  ...
  return (
    <div className={`lg:col-span-2 fixed top-0 
        bg-[#1f1b28] w-full h-full lg:w-96 lg:right-0
        transition-all z-50 ${showOrder ? "right-0" : "-right-full"}`}>
          {/*Orders*/}
          <div className='relative pt-16 text-gray-300 p-8 h-full lg:pt-8'>
            ...
            <div>
              ...
              {/*Products*/}
              <div className='h-[400px] md:h-[1000px] lg:h-[500px] overflow-scroll'>
                {/*Product*/}
                <div className='bg-[#262837] p-4 rounded-xl mb-4'>
                  <div className='grid grid-cols-6 mb-4'>
                    ...
                    <div className='flex items-center gap-3 col-span-4'>
                      ...
                      className='w-10 h-10'/>
                      <div>
                      <h5 className='text-sm'>Sapicy seaso...</h5>
                  ...
                  <div className='grid grid-cols-6 items-center gap-2'>
                    <form className='col-span-5'>
                      <input type="text" 
                      className='bg-[#1f1b28] py-2 px-4 rounded-lg outline-none'
